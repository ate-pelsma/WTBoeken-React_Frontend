...
export const CreateBook = ({ data, isbn, alert }) => {
  ...
  const updateBookForm = () => {
    if (data) {
      const imgUrl = data.cover
        ? data.cover.medium
        : "https://images.cdn3.stockunlimited.net/preview1300/book-icon_1648785.jpg";
  ...
  const buildImgElement = () => {
    const imgElement = newBook.image ? (
      <img src={newBook.image} alt="No Image" style={{ width: "200px" }}></img>
    ) : (
      <div></div>
    );
    return imgElement;
            ...
            <form>
              ...
              <div className="mt-3 d-flex justify-content-center">
                <Button
                  onClick={handleClick}
                  type="button"
                  className="buttonGreen ml-0 mt-2"
                  variant="success"
                >
                  Opslaan
                </Button>
